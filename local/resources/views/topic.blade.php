                                ...
                                <div class="small-12 columns form-inline">
                                    <label for="answer_upload">
                                           <span class="filetype_label">Select a file to upload <small>(&lt;5MB)</small></span>:
                                            <input data-abide-validator="filesize" type="file" id="answer_upload" name="answer_upload" class="inputfile"/>
                                            <div>
                           ...
                           <!-- buttons -->
                            ...
                            <div class="row type_input input_file" id="instruction_input_upload" style="display: none;"> <!-- Div om file upload mogelijk te maken -->
                                <div class="small-12 columns form-inline">
                                    ...
                                    <label for="instruction_upload">
                                           <span class="filetype_label">Select a file to upload <small>(&lt;5MB)</small></span>:
                                            <input data-abide-validator="filesize" type="file" id="instruction_upload" name="instruction_upload" class="inputfile"/>
                                            <div>
                                               <span class="file_reset">
                                                    remove
                                                </span>
